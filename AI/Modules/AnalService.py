...
INSTRUCTION = """
    ...
    * Speech To Text
    ...
    originalScript 각색:
    * 각색한 부분 및 전 문장은 originalScript 와 결론적 의미가 일치, * originalScript의 기승전결 및 말투(~해요, ~하나요? ~합니다 등)을 파악후 모방
    ...
    editedScript 생성:
    스크립트를 한국어 의미 단위로 쪼개서 editedScript출력구조에 맞게 반환해. 한국어 의미 단위란 주어, 목적어, 서술어를 뜻한다.
